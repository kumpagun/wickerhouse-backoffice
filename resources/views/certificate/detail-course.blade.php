...
<div class="col-12">
  <div class="form-group">
    ...
    <div class="controls">
      <input type="text" name="course_color" class="form-control jscolor" maxlength="6" minlength="6" value="@if(empty($data->course_color)){{000000}}@else{{$data->course_color}}@endif" required>
    </div>
    </p>
  </div>
</div>
