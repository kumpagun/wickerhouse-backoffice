...
@php $title = strtoupper('add department'); @endphp
...
<div class="row breadcrumbs-top">
  <div class="breadcrumb-wrapper col-12">
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="{{ route('department_index') }}">Department</a></li>
        ...
        <div class="card-body pt-0">
          <form class="form-horizontal" action="{{ route('store_department') }}" method="POST">
            ...
            <fieldset class="form-group floating-label-form-group @if($errors->department->has('title')) danger @endif">
              ...
              <input type="text" name="title" class="form-control" id="user-name" value="{{ old('title', $data->title) }}" placeholder="Department Name">
