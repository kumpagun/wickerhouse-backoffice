...
class Export_Review_Training_Byuser implements FromView
{

  public function __construct($training,$review_group,$review_group_arr,$total_reviews_arr,$reviews,$reviews_arr,$employees,$datas_report,$datas_report_createdAt)
  {
