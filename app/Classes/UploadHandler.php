...
class UploadHandler
{
    ...
    public function __construct($custom_filename, $options = null, $initialize = true, $error_messages = null) {
        $this->response = array();
        $this->options = array(
            ...
            // 'readfile_chunk_size' => 20000000, // 10 MiB
		...
		*/
        ...
        if ($initialize) {
            $this->initialize($custom_filename);
        }
    }

    protected function initialize($custom_filename=null) {
        switch ($this->get_server_var('REQUEST_METHOD')) {
            ...
            case 'PUT':
            case 'POST':
                $this->post($this->options['print_response'], $custom_filename);
                break;
            case 'DELETE':
    ...
    public function post($print_response = true, $custom_filename=null) {
        $extension_array = [
            'video/mp4'         => '.mp4',
            'video/quicktime'   => '.mov',
            'video/x-msvideo'   => '.avi',
            ...
            if (is_array($upload['tmp_name'])) {
                ...
                foreach ($upload['tmp_name'] as $index => $value) {
                    $files[] = $this->handle_file_upload(
                        ...
                        $custom_filename.$extension_array[$upload['type'][$index]],
